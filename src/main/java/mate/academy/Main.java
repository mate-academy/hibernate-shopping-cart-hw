...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            authService.register(john.getEmail(), john.getPassword());
        } catch (RegistrationException e) {
            System.out.println(e);
        }

        try {
            authService.login("test@gmail.com", "test");
            authService.login("john", "john");
        ...
        shoppingCartService.addSession(tomorrowMovieSession, bobCart.getUser());
