...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            bobRoss = authenticationService.login(bobRoss.getEmail(), bobRoss.getPassword());
        ...
        shoppingCartService.addSession(tomorrowMovieSession, bobRoss);

        ShoppingCart shoppingCart = shoppingCartService.getByUser(bobRoss);
        System.out.println(shoppingCart);

        shoppingCartService.clear(shoppingCart);
        System.out.println(shoppingCartService.getByUser(bobRoss));
    }
}
