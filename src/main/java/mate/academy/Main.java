...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        String bobPassword = "123458";

        System.out.println(authenticationService.register(bobEmail, bobPassword));
        System.out.println(authenticationService.login(bobEmail, bobPassword));
        User bob = authenticationService.login(bobEmail, bobPassword);
