...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User james;
        try {
            bob = authenticationService.register("bob45@gmail.com", "12343");
            james = authenticationService.register("jame2s2@ukr.net", "bted5jks");
        ...
        shoppingCartService.addSession(tomorrowMovieSession, james);
        shoppingCartService.addSession(tomorrowMovieSession, bob);
        shoppingCartService.addSession(tomorrowMovieSession, bob);
        ShoppingCart jamesShoppingCart = shoppingCartService.getByUser(james);
        shoppingCartService.clear(jamesShoppingCart);
    }
}
