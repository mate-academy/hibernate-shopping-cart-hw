...
public class Main {
    ...
    public static void main(String[] args)
        ...
        authenticationService.register("cat@gmail.com", "TomCat");
        User tomCat = authenticationService.login("cat@gmail.com", "TomCat");
        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(tomorrowMovieSession, tomCat);
        shoppingCartService.addSession(yesterdayMovieSession, tomCat);
        ShoppingCart shoppingCart = shoppingCartService.getByUser(tomCat);
