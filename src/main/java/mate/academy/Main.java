...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("bob shopping cart: " + bobShoppingCart);
        System.out.println("alice shopping cart: " + aliceShoppingCart);
        shoppingCartService.clear(bobShoppingCart);
        System.out.println("bob shopping cart after clear: " + bobShoppingCart);
    }
}
