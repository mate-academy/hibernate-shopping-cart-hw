...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            User anton = authenticationService.register("anton@gmail.com", "password");
            ...
            ShoppingCart antonShoppingCart = shoppingCartService.getByUser(anton);
            System.out.println(antonShoppingCart);
