...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        User bobFromDB = authenticationService.register(bob.getEmail(), bob.getPassword());

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) inject.getInstance(ShoppingCartService.class);
        ShoppingCart shoppingCartByBobFromDB = shoppingCartService.getByUser(bobFromDB);
        System.out.println("Shopping cart by user from DB " + shoppingCartByBobFromDB);
        shoppingCartService.addSession(tomorrowMovieSession, bobFromDB);
        shoppingCartByBobFromDB = shoppingCartService.getByUser(bobFromDB);
        System.out.println("Shopping cart by user with tickets " + shoppingCartByBobFromDB);
        shoppingCartService.clear(shoppingCartByBobFromDB);
        System.out.println("Shopping cart by user without tickets " + shoppingCartByBobFromDB);
    }
}
