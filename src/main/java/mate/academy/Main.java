...
public class Main {
    public static void main(String[] args) {
        ...
        User user2 = new User();
        try {
            user1 = authenticationService.register("user1@mail.com", "pass");
            user2 = authenticationService.register("user2@mail.com", "password");
        ...
        ShoppingCart bobShoppingCart = shoppingCartService.getByUser(user1);
        ShoppingCart aliceShoppingCart = shoppingCartService.getByUser(user2);
