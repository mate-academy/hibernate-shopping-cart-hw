...
public class Main {
    ...
    private static final String USER_EMAIL = "loki@mate.academy";
    private static final String USER_PASSWORD = "8GWGme69rn";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new RuntimeException("Can't register user: " + USER_EMAIL, e);
        }
