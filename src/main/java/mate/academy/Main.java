...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        User max = authenticationService.register(email, password);

        shoppingCartService.addSession(tomorrowMovieSession, max);
        ShoppingCart maxShoppingCart = shoppingCartService.getByUser(max);
        System.out.println(maxShoppingCart);
    }
}
