...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userAlice.setEmail("userAlice@gmail.com");
        userAlice.setPassword("alicePassword");
        try {
            System.out.println(authenticationService.register("userBob@gmail.com",
                    "bobPassword"));
            System.out.println(authenticationService.register("userAlice@gmail.com",
                    "alicePassword"));
        ...
        try {
            System.out.println(authenticationService.login(userBob.getEmail(),
                    userBob.getPassword()));
            System.out.println(authenticationService.login(userAlice.getEmail(),
                    userAlice.getPassword()));
        ...
        shoppingCartService.registerNewShoppingCart(userAlice);
        ...
        shoppingCartService.getByUser(userAlice);
    }
}
