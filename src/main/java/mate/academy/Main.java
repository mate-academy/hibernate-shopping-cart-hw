...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Ticket fastFuriousTicket = new Ticket();
        fastFuriousTicket.setUser(alice);
        fastFuriousTicket.setMovieSession(yesterdayMovieSession);
        System.out.println(ticketDao.add(fastFuriousTicket));
        ...
        ShoppingCart aliceShoppingCart = shoppingCartService
                .getByUser(alice);
        System.out.println(aliceShoppingCart);
        System.out.println("Alice shopping cart was CLEARED");
