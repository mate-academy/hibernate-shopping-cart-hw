...
public class Main {
    ...
    private static final String EMAIL = "firstUser@gmail.com";
    private static final String PASSWORD = "^&25GuKoP-§*7h+";
    ...
    public static void main(String[] args) {
        ...
        User user;
        try {
            System.out.println(user = authenticationService.register(EMAIL,
                    PASSWORD));
