...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User user = null;
        try {
            user = authenticationService.register("email", "1234");
        ...
        System.out.println(shoppingCartFromDB.getTickets().size());

        shoppingCartService.addSession(yesterdayMovieSession, user);

        shoppingCartFromDB = shoppingCartService.getByUser(user);
        System.out.println(shoppingCartFromDB.getTickets().size());
