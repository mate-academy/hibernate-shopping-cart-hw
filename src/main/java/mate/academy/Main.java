...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authenticationService.register("bob@mail.com", "qwerty");
        User bob = authenticationService.login("bob@mail.com", "qwerty");
        authenticationService.register("alice@mail.com", "qwerty");
        User alice = authenticationService.login("alice@mail.com", "qwerty");
