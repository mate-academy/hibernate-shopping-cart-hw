...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User user = null;
        try {
            user = authenticationService.register("user.to.db@gmail.com", "123456");
        } catch (RegistrationException e) {
            throw new RuntimeException("Something went wrong", e);
        }
        System.out.println(shoppingCartService.getByUser(abrams));
        shoppingCartService.addSession(tomorrowMovieSession, abrams);
        System.out.println(shoppingCartService.getByUser(abrams));
        shoppingCartService.clear(shoppingCartService.getByUser(abrams));
        System.out.println(shoppingCartService.getByUser(abrams));
