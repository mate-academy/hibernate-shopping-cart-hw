...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        ShoppingCart shoppingCartFindByUser = shoppingCartService.getByUser(bobFromDb);
        System.out.println(shoppingCartFindByUser);
        shoppingCartService.clear(shoppingCartFindByUser);
        System.out.println(shoppingCartFindByUser);
    }
}
