...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User newUser = null;
        newUser = authenticationService.register("TEST@qwerty.net", "1234");
        ...
        ShoppingCart nickShoppingCart = shoppingCartService.getByUser(newUser);
        System.out.println(nickShoppingCart);

        shoppingCartService.clear(nickShoppingCart);
