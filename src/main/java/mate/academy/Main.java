...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        authenticationService.register("domenicTorreto.com", "family");
        User dominic = authenticationService.login("domenicTorreto.com", "family");
        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(tomorrowMovieSession, dominic);
        shoppingCartService.addSession(yesterdayMovieSession, dominic);
        ShoppingCart shoppingCart = shoppingCartService.getByUser(dominic);
