...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        User userFromDb = authenticationService.login("alice@gmail.com", "qwerty");
        System.out.println(userFromDb);

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(tomorrowMovieSession, userFromDb);
        ShoppingCart userShoppingCart = shoppingCartService.getByUser(userFromDb);
        userShoppingCart.getTickets().forEach(ticket -> System.out.println(ticket));
