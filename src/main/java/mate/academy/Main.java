...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authenticationService.register("mail@gmail.com", "qwerty");
        User testUser = authenticationService.login("mail@gmail.com", "qwerty");
        ...
        System.out.println(
                "Shopping cart " + shoppingCartService.getByUser(testUser)
                        + " for user " + testUser
                        + " successfully created and added"
        );
        shoppingCartService.clear(shoppingCartService.getByUser(testUser));
        System.out.println(
                "Shopping cart has follow view after clearing "
