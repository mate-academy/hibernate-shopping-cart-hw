...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        AuthenticationService authenticationService =
                (AuthenticationService) serviceInjector.getInstance(AuthenticationService.class);
        User registeredUser = authenticationService.register("user@gmail.com", "123456");

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) serviceInjector.getInstance(ShoppingCartService.class);
