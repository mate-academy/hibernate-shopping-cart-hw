...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        userBob.setPassword("userBob");
        userService.add(userBob);
        System.out.println("Here is user by e-mail bob@gmail.com"
                + userService.findByEmail(userBob.getEmail()));

        shoppingCartService.registerNewShoppingCart(userBob);
        System.out.println("Shopping cart for Bob was created");

        shoppingCartService.addSession(tomorrowMovieSession, userBob);
        System.out.println("Session was added to shopping cart");

        ShoppingCart bobShoppingCart = shoppingCartService.getByUser(userBob);
        System.out.println("Shopping cart of bob is " + bobShoppingCart);

        shoppingCartService.clear(bobShoppingCart);
        System.out.println("Bob's shopping cart was cleared"
                + shoppingCartService.getByUser(userBob));
    }
}
