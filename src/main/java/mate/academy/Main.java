...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        shoppingCartService.addSession(tomorrowMovieSession, savedUserNazar);
        ShoppingCart shoppingCartFromDB = shoppingCartService.getByUser(savedUserNazar);
        System.out.println(shoppingCartFromDB);
        shoppingCartService.clear(shoppingCartFromDB);
        System.out.println(shoppingCartService.getByUser(savedUserNazar));
    }
}
