...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            userBob = authenticationService.register("bob@gmail.com", "Bob12345");
            userAlice = authenticationService.register("alice@gmail.com", "Alice12345");

        } catch (RegistrationException e) {
            throw new RuntimeException("Registration faild", e);
        }
