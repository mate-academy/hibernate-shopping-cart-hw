...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        john.setPassword("qwerty");
        try {
            john = authenticationService.register(john.getEmail(), john.getPassword());
            authenticationService.login("john@gmail.com", "qwerty");
        ...
        ShoppingCart johnsShoppingCart = shoppingCartService.getByUser(john);

        System.out.println(johnsShoppingCart);
        shoppingCartService.clear(johnsShoppingCart);
