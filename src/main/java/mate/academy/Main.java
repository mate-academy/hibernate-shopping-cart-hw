...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authenticationService.login(registeredUser.getEmail(), registeredUser.getPassword());

        ShoppingCartService shoppingCartService = (ShoppingCartServiceImpl)
