...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new RuntimeException("Can't register a user with email: "
            + bob.getEmail() + ", and password: " + bob.getPassword(), e);
        } catch (AuthenticationException e) {
            throw new RuntimeException("Can't login a user with email: "
                    + bob.getEmail() + ", and password: " + bob.getPassword(), e);
        }
        ...
        User userBob = userService.findByEmail(bob.getEmail()).orElseThrow();
