...
public class Main {
    ...
    public static final AuthenticationService authenticationService = (AuthenticationService)
            injector.getInstance(AuthenticationService.class);
    public static final ShoppingCartService shoppingCartService = (ShoppingCartService)
    ...
    public static void main(String[] args) {
        ...
        User bob = new User();
        try {
            bob = authenticationService.register("bob@gmail.com", "qwerty123");
        } catch (AuthenticationException e) {
            System.out.println("User registering failed");
        }
        try {
            authenticationService.login("bob@gmail.com", "qwerty123");
        } catch (AuthenticationException e) {
