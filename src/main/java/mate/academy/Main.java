...
public class Main {
    ...
    public static void main(String[] args)
        ...
        User firstUser = authenticationService
                .register("some@mail.com", "password");
        User loginFirstUser = authenticationService
                .login(firstUser.getEmail(), "password");
        System.out.println(firstUser);
        System.out.println(loginFirstUser);
