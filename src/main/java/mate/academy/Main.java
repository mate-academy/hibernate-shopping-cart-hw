...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException, AuthenticationException {
        ...
        authenticationService.register("bob@gmail.com", "B1234");
        authenticationService.register("peter@gmail.com", "P1234");

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) inject.getInstance(ShoppingCartService.class);
        ShoppingCart shoppingCart = shoppingCartService.getByUser(authenticationService
