...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User tanyaL;
        try {
            tanyaL = authenticationService.register("tanyal96@gmail.com", "12345");
        } catch (RegistrationException e) {
            throw new RuntimeException(e.getMessage(), e);
        }
        ShoppingCart shoppingCartTanya = shoppingCartService.getByUser(tanyaL);
        shoppingCartService.addSession(tomorrowMovieSession, shoppingCartTanya.getUser());
        System.out.println(shoppingCartService.getByUser(tanyaL));
