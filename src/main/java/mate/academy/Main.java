...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            authenticationService.register("email@mail.com", "1234");
        } catch (RegistrationException e) {
            System.out.println("Try again, the user with such email already exists in DB");
        }
        ...
        shoppingCartService.addSession(tomorrowMovieSession,
                userService.findByEmail("email@mail.com").get());
        System.out.println(shoppingCartService.getByUser(
                userService.findByEmail("email@mail.com").get()));
        shoppingCartService.clear(shoppingCartService.getByUser(
                userService.findByEmail("email@mail.com").get()));
    }
}
