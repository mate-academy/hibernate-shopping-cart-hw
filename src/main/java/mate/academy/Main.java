...
public class Main {
    public static void main(String[] args) {
        ...
        User petrov;
        try {
            ivanov = authenticationService.register("ivan.ivanov@gmail.com", "12345678");
            petrov = authenticationService.register("petro.petrov@gmail.com", "87654321");
        ...
        shoppingCartService.addSession(yesterdayMovieSession, ivanov);
