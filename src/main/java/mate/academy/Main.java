...
public class Main {
    ...
    public static void main(String[] args) throws RegistrationException {
        ...
        User user1 = authenticationService.register("myemail@mail.com", "qwerty");
        User user2 = authenticationService.register("myemail2@mail.com", "1212");
        ...
        User user3 = new User();
        user3.setEmail("myemail33@mail");
        user3.setPassword("6788");
