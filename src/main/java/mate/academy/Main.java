...
public class Main {
    public static void main(String[] args) {
        ...
        User user = new User();
        user.setEmail("DeStRoYeRRR2003@yahoo.com");
        user.setPassword("DontTouchMyXboxMommyPLZMOM123");
        User registeredUser;
        try {
            registeredUser = authenticationService.register(user.getEmail(), user.getPassword());
