...
public class Main {
    public static void main(String[] args) {
        ...
        User sema;
        try {
            sema = authenticationService.register("sema123@gmail.com", "sema");
        ...
        System.out.println(shoppingCartService.getByUser(sema));
        shoppingCartService.addSession(tomorrowMovieSession, sema);
        shoppingCartService.addSession(yesterdayMovieSession, sema);
        System.out.println(shoppingCartService.getByUser(sema));
    }
}
