...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            authenticationService.login("bob2Email", "bobPassword");
        ...
        shoppingCartService.registerNewShoppingCart(userService.findByEmail("bob2Email").get());
        shoppingCartService.registerNewShoppingCart(userService.findByEmail("alice2Email").get());
        shoppingCartService.addSession(movieSessionService.get(1L),
                userService.findByEmail("bob2Email").get());
    }
}
