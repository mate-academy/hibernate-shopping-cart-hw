...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        User bob = userService.findByEmail("bob@gmail.com").orElseThrow(
                () -> new RuntimeException("No such user in DB"));
        System.out.println(bob);
        try {
            authenticationService.login("bob@gmail.com", "password");
        } catch (AuthenticationException e) {
            throw new RuntimeException("Can't log user in", e);
        }

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(
                tomorrowMovieSession, userService.findByEmail("bob@gmail.com")
