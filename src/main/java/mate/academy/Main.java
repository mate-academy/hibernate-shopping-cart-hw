...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(movieSessionService.findAvailableSessions(
                fastAndFurious.getId(), LocalDate.now().minusDays(1L)));

        User userBob = new User("bob@gmail.com", "1234");
        User userAlice = new User("alice@gmail.com", "4321");
        ...
        try {
            ...
            authenticationService.login("ivan@gmail.com", userBob.getPassword());
        } catch (AuthenticationException e) {
            System.out.printf("AuthenticationException was thrown: %s%n", e);
        }

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        shoppingCartService.addSession(tomorrowMovieSession, userBob);
        shoppingCartService.addSession(yesterdayMovieSession, userAlice);
        System.out.println(shoppingCartService.getByUser(userBob));
        shoppingCartService.clear(shoppingCartService.getByUser(userAlice));
