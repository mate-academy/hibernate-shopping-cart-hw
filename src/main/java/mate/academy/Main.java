...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        System.out.println(authenticationService.login(alice.getEmail(), "1234"));

        ShoppingCartService shoppingCartService =
                (ShoppingCartService) injector.getInstance(ShoppingCartService.class);
        System.out.println("***************Shopping cart is empty now: ");
        ShoppingCart aliceShoppingCart = shoppingCartService.getByUser(alice);
        System.out.println(aliceShoppingCart);

        System.out.println("***************Shopping cart after adding tickets: ");
        ...
        System.out.println("***************Shopping cart after clear: ");
