...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public void addSession(MovieSession movieSession, User user) {
        ...
        System.out.println(ticket); //delete at the final
    ...
    public void clear(ShoppingCart shoppingCart) {
        ShoppingCart shoppingCartFromDB = shoppingCartDao.getByUser(shoppingCart.getUser()).get();
        shoppingCartFromDB.getTickets().clear();
        shoppingCartDao.update(shoppingCartFromDB);
    }
}
