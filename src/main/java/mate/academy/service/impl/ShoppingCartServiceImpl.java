...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public void addSession(MovieSession movieSession, User user) {
        ...
        ShoppingCart currentShoppingCart = shoppingCartDao
                .getByUser(user).orElseThrow();
        List<Ticket> newList = currentShoppingCart.getTickets();
        newList.add(newTicket);
        currentShoppingCart.setTickets(newList);
