...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public void addSession(MovieSession movieSession, User user) {
        ...
        cart.setTickets((List<Ticket>) ticket);
    ...
    public void registerNewShoppingCart(User user) throws RegistrationException {
        ...
        if (shoppingCartFromDb.isEmpty()) {
            throw new RegistrationException("This shopping cart is registered");
        }
    ...
    public void clear(ShoppingCart shoppingCart) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            ...
            throw new DataProcessingException("Can't clear all about shopping cart: "
                    + shoppingCart, e);
        }
    }
}
