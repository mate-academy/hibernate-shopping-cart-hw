...
public class ShoppingCartDaoImpl implements ShoppingCartDao {
    ...
    public Optional<ShoppingCart> getByUser(User user) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<ShoppingCart> shoppingCartUser = session.createQuery("FROM ShoppingCart sc "
            ...
            shoppingCartUser.setParameter("id", user);
            return Optional.ofNullable(shoppingCartUser.getSingleResult());
        } catch (Exception e) {
