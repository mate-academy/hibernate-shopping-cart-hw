...
public class ShoppingCartDaoImpl implements ShoppingCartDao {
    ...
    public ShoppingCart add(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't add sopping card" + shoppingCart, e);
        } finally {
            if (session != null) {
                session.close();
            }
    ...
    public Optional<ShoppingCart> getByUser(User user) {
        try (Session session = HibernateUtil.getSessionFactory().openSession()) {
            Query<ShoppingCart> getShoppingCartByUserQuery =
                    session.createQuery("FROM ShoppingCart shc "
    ...
    public void update(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Can't update sopping card" + shoppingCart, e);
        } finally {
            if (session != null) {
                session.close();
            }
