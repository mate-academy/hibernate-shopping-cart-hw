...
public class ShoppingCartDaoImpl implements ShoppingCartDao {
    ...
    public ShoppingCart add(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Could not add ShoppingCart " + shoppingCart
                    + " to database", e);
        } finally {
            if (session != null) {
                session.close();
    ...
    public void update(ShoppingCart shoppingCart) {
        ...
        try {
            ...
            throw new DataProcessingException("Could not update ShoppingCart " + shoppingCart, e);
        } finally {
            if (session != null) {
                session.close();
            }
